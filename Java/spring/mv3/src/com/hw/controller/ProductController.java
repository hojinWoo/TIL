...
public class ProductController {
	...
	public String list(Model m) {
		...
		m.addAttribute("center", "product/list"); // center는 userlist로 바껴라
		return "main";
	}

	@RequestMapping("/productadd.do")
	public String add(Model m) {
		m.addAttribute("center", "product/add"); // center는 userlist로 바껴라
		return "main";
	}
	...
	public String addimpl(Model m,Product p) {
		...
		m.addAttribute("center", "product/addok"); // center는 userlist로 바껴라
		return "main";
	}
}
